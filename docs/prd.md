...
- **API Key Configuration**:Gemini API key is securely managed via environment variables (`VITE_GEMINI_API_KEY`) and is **never committed to the repository**.
...
- **Provided API Key**: Gemini API key is securely managed via environment variables (`VITE_GEMINI_API_KEY`) and is **never committed to the repository**.
- **Environment Variable Storage**: The Gemini API key is securely managed via environment variables (`VITE_GEMINI_API_KEY`) and is **never committed to the repository**.
...
- **Gemini API**: **Google Gemini 2.5 Flash API** for image description extraction and intelligent matching
  - **API Key**: Gemini API key is securely managed via environment variables (`VITE_GEMINI_API_KEY`) and is **never committed to the repository**.
